...
# we need a function to validate the input as a specific date format, such as YYYY-MM-DD
...
# for the start only, calculate TMIN, TAVG, and TMAX for all dates greater than and equal to start date
...
# for the start and end dates, calculate TMIN, TAVG, and TMAX for all dates greater than and equal to start date
